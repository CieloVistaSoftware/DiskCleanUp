...
status: active
tags: [app, application, arch, architecture, diskcleanup, diskcleanuptray, entirely, launcher, lives, minimal, notifyicon, system, tray, using, visible, window, winforms]
