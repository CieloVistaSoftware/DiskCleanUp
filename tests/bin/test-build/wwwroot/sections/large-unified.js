...
const _filterBar = FilterBar.create('large', {
    container: 'large-filter-container',
    onApply: (state) => _applyFilter(state),
});
const _toolbar = Toolbar.create('large', {
...
function _applyFilter(state) {
    ...
    _filterBar.setRowCount(text ? `Showing ${visible} of ${total}` : `${total} rows`);
...
//# sourceMappingURL=large-unified.js.map