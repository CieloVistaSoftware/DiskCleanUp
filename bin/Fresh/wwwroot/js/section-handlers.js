...
// STALE — migrated to stale-unified.js (Phase 6.1)
...
// LARGE — migrated to large-unified.js (Phase 6.2)
// _registerStandardSection({
//   section: 'large',
...
// NODE-MODULES — migrated to node-modules-unified.js (Phase 6.3)
// _registerStandardSection({
...
registerHandler('images', (msg) => {
  if (msg.type === 'started') {
    ...
    if (delBtn) { delBtn.style.display = 'none'; delBtn.disabled = false; delBtn.textContent = '\ud83d\uddd1 Delete All Copies'; }
